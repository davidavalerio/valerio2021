...
for CO2s0i in CO2s0:
    ...
    k21 = 0.00165 * GPPx # photosynthesis rate constant yr^-1
...
fig1.plot(CO2s, D17_CO2s, label = '150% GPP', color = 'green')
fig1.legend(loc='best')
plt.tight_layout()
plt.savefig('D17tvtCO2s150.jpg', dpi=800)
...
fig2.plot(CO2s, xO2s, label = '150% GPP', color = 'green')
