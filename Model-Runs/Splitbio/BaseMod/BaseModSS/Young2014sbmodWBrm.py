...
K48 = K47 * (1/2) # CO2 + Q1D -> CO2 + Q mol/yr
K49 = K47 * (1/2) # CO2 + Q1D -> COQ + O mol/yr
K50 = K47 * (1/2) # COQ + O1D -> CO2 + Q mol/yr
K51 = K47 * (1/2) # COQ + O1D -> COQ + O mol/yr
K52 = K47 * (1/2) # CO2 + X1D -> CO2 + X mol/yr
K53 = K47 * (1/2) # CO2 + X1D -> COX + O mol/yr
K54 = K47 * (1/2) # COX + O1D -> CO2 + X mol/yr
K55 = K47 * (1/2) # COX + O1D -> COX + O mol/yr
...
writer = pd.ExcelWriter('Young2014splitbiomodWBSSrm.xlsx', engine = 'xlsxwriter')
