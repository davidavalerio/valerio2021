...
trespmar = np.array([.506, .512, .5149, .516, .520])

# For loop for different tresp values
for trespi in trespmar:
    ...
    for ft in ftx:
        ...
        def f(y, t):
            ...
            kOXtO = (k12t * (alphart ** tresp) + k12m * (alpharm ** trespi) + k13 + k14)
...
# Saving figure
plt.savefig('D17O2tvtrespmarFtmod.jpg', dpi=800)
