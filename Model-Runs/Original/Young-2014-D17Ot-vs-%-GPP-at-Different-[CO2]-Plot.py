...
This model run produces a plot showing changes in the oxygen-triple isotope composition of oxygen in the troposphere as a function
of the percent of modern gross primary productivity for different CO2 concentrations in the atmosphere.
...
# D17 as function of % Modern GPP at different [CO2]
D17_GPPx94 = []
for i in sol[0:10]:
    D17 = i.loc['D17_O2t'].values
    D17_GPPx94.append(D17)
    
D17_GPPx94 = np.hstack(D17_GPPx94)

D17_GPPx194 = []

for i in sol[10:20]:
    D17 = i.loc['D17_O2t'].values
    D17_GPPx194.append(D17)
    
D17_GPPx194 = np.hstack(D17_GPPx194)

D17_GPPx294 = []
for i in sol[20:30]:
    D17 = i.loc['D17_O2t'].values
    D17_GPPx294.append(D17)
    
D17_GPPx294 = np.hstack(D17_GPPx294)

D17_GPPx394 = []
for i in sol[30:40]:
    D17 = i.loc['D17_O2t'].values
    D17_GPPx394.append(D17)
    
D17_GPPx394 = np.hstack(D17_GPPx394)

D17_GPPx494 = []
for i in sol[40:50]:
    D17 = i.loc['D17_O2t'].values
    D17_GPPx494.append(D17)
    
D17_GPPx494 = np.hstack(D17_GPPx494)

D17_GPPx594 = []
for i in sol[50:60]:
    D17 = i.loc['D17_O2t'].values
    D17_GPPx594.append(D17)
    
D17_GPPx594 = np.hstack(D17_GPPx594)

D17_GPPx694 = []
for i in sol[60:70]:
    D17 = i.loc['D17_O2t'].values
    D17_GPPx694.append(D17)
    
D17_GPPx694 = np.hstack(D17_GPPx694)

D17_GPPx794 = []
for i in sol[70:80]:
    D17 = i.loc['D17_O2t'].values
    D17_GPPx794.append(D17)
    
D17_GPPx794 = np.hstack(D17_GPPx794)

D17_GPPx894 = []
for i in sol[80:90]:
    D17 = i.loc['D17_O2t'].values
    D17_GPPx894.append(D17)
    
D17_GPPx894 = np.hstack(D17_GPPx894)

D17_GPPx994 = []
for i in sol[90:100]:
    D17 = i.loc['D17_O2t'].values
    D17_GPPx994.append(D17)
    
D17_GPPx994 = np.hstack(D17_GPPx994)

D17_GPPx1094 = []
for i in sol[100:110]:
    D17 = i.loc['D17_O2t'].values
    D17_GPPx1094.append(D17)
    
D17_GPPx1094 = np.hstack(D17_GPPx1094)

# Setting up figure parameters
fig1 = plt.figure(figsize = (5, 5))
with sns.axes_style("whitegrid"):
    fig1 = fig1.add_subplot(1, 1, 1)
fig1.set(xlim = (50, 150), ylim = (-.7, -.3))

# Title and x and y labels
fig1.set_xlabel("% Modern GPP")
fig1.set_ylabel("$^{17}\Delta$ $O_2, $$_{trop}$ (‰)")
fig1.set_title("$^{17}\Delta$ $O_2, $$_{trop}$ vs. % Modern GPP")

# GPP range in percent
GPPx = GPPx * 100

# Plotting D17 of O2t as function of [CO2]
fig1.plot(GPPx, D17_GPPx94, label = '94 ppm CO2', color = 'blue')
fig1.plot(GPPx, D17_GPPx194, label = '194 ppm CO2', color = 'orange')
fig1.plot(GPPx, D17_GPPx294, label = '294 ppm CO2', color = 'green')
fig1.plot(GPPx, D17_GPPx394, label = '394 ppm CO2', color = 'red')
fig1.plot(GPPx, D17_GPPx494, label = '494 ppm CO2', color = 'purple')
fig1.plot(GPPx, D17_GPPx594, label = '594 ppm CO2', color = 'brown')
fig1.plot(GPPx, D17_GPPx694, label = '694 ppm CO2', color = 'pink')
fig1.plot(GPPx, D17_GPPx794, label = '794 ppm CO2', color = 'gray')
fig1.plot(GPPx, D17_GPPx894, label = '894 ppm CO2', color = 'olive')
fig1.plot(GPPx, D17_GPPx994, label = '994 ppm CO2', color = 'cyan')
fig1.plot(GPPx, D17_GPPx1094, label = '1094 ppm CO2', color = 'black')
...
# Legend
fig1.legend(loc='upper center', bbox_to_anchor=(1.5, 0.80))
plt.tight_layout()
plt.savefig('D17O2tvGPPxCO2x.jpg', dpi=800)