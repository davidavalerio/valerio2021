...
fig1.plot(fCOX1, D17_tGA1HHS, color='#364b9a',
          label='$\Theta_{COX}$ = 0.516, $\Theta_{terrestrial\:MR}$ = 0.497')
fig1.plot(fCOX1, D17_tGA1AHS, color='#a50026',
          label='$\Theta_{COX}$ = 0.520, $\Theta_{terrestrial\:MR}$ = 0.497')
...
# Labels and legend
fig1.set_xlabel("$\Theta_{COX}$ Fraction of $\Theta_{\:O_2\:uptake}$ ($f_{COX}$) with $f_{terrestrial\:MR}$ = 0.1")
...
fig1ax2.set_xlabel('$\Theta_{PR}$ Fraction of $\Theta_{\:O_2\:uptake}$ ($f_{PR}$) with $f_{terrestrial\:MR}$ = 0.1')

# Saving figure
plt.tight_layout()
plt.savefig('D17O2tfCOXfPRfMR.jpg', dpi=800)
