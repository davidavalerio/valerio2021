...
print("fCOX for Wostbrock2020 given tCOXHelman and tPRHelman is " + str(fCOXHHWB) + ".")
print("fPR for Wostbrock2020 given tCOXHelman and tPRHelman is " + str(1 - fCOXHHWB) + ".")
print("fCOX for Young2014 given tCOXAsh and tPRHelman is " + str(fCOXAHYO) + ".")
...
plt.vlines(0.74, -1, 0, color='green', linestyles='dotted',
           label = 'Angert2003, fCOX = 0.74')
...
fig2.set_xlabel("COX Relative Contribution to $\Theta_{GA}$ (fCOX)")
fig2.set_ylabel("$^{17}\Delta$ $O_{2, trop}$ (‰)")
fig2.set_title("$^{17}\Delta$ $O_{2, trop}$ vs. fCOX")
