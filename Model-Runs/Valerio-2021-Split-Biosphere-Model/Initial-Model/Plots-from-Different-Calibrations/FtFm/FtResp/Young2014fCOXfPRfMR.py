...
plt.vlines(0.67, -1, 0, color='green', linestyles='dotted',
           label = 'Angert2003, fCOX = 0.67')
...
fig1.set_xlabel("COX Relative Contribution to Θ$_{GA}$ (fCOX)")
fig1.set_ylabel("$^{17}\Delta$ $O_{2, trop}$ (‰)")
fig1.set_title("$^{17}\Delta$ $O_{2, trop}$ vs. fCOX for fMR = 0.1")
