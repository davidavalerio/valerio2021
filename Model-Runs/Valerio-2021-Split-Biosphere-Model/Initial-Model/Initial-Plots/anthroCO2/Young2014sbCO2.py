...
#%% Determine the initial moles of relevant species
...
fig2.set(xlim = (-(tpre), tpost), ylim = (23.28, 23.32))
...
fig4.set(xlim = (-(tpre), tpost), ylim = (51.8, 52.1))
...
fig5.set(xlim = (-(tpre), tpost), ylim = (-0.65, -0.55))
...
fig6.set(xlim = (-(tpre), tpost), ylim = (71.1, 71.25))
...
fig7.set(xlim = (-(tpre), tpost), ylim = (26.8, 27.1))
...
fig8.set(xlim = (-(tpre), tpost), ylim = (30, 50))
...
fig10.set(xlim = (-(tpre), tpost), ylim = (76.2, 76.5))
...
fig12.set(xlim = (-(tpre), tpost), ylim = (40.1, 40.15))
...
fig13.set(xlim = (-(tpre), tpost), ylim = (0.32, 0.4))
...
# Plot d18 O2g vs. time
fig14 = plt.figure(figsize = (5, 5))
with sns.axes_style("whitegrid"):
    fig14 = fig14.add_subplot(1, 1, 1)
fig14.set(xlim = (-(tpre), tpost), ylim = (1.4, 1.7))
plt.plot(tplot, d18_O2g, color='brown')
plt.xlabel("Time (years)")
plt.ylabel("$\delta^{18}$O$_2, {geo}$")
plt.title("$\delta^{18}$O$_2, {geo}$ 280 to 410 ppm")
plt.tight_layout()
plt.savefig("d18O2g280to410.jpg", dpi = 800)

# Plot D17 O2g vs. time
fig15 = plt.figure(figsize = (5, 5))
with sns.axes_style("whitegrid"):
    fig15 = fig15.add_subplot(1, 1, 1)
fig15.set(xlim = (-(tpre), tpost), ylim = (-0.1, 0))
plt.plot(tplot, D17_O2g, color='brown')
plt.xlabel("Time (years)")
plt.ylabel("$^{17}\Delta$ O$_2, {geo}$")
plt.title("$^{17}\Delta$ O$_2, {geo}$ 280 to 410 ppm")
plt.tight_layout()
plt.savefig("D17O2g280to410.jpg", dpi = 800)
