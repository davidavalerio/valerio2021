...
reg = stats.linregress(ftx, D17_ft)

# Print linear regression equation
print("y5149 = " + str(reg.slope) + "  * x + " + str(reg.intercept))

# Setting up figure parameters
fig1 = plt.figure(figsize = (5, 5))
with sns.axes_style("whitegrid"):
    fig1 = fig1.add_subplot(1, 1, 1)
fig1.set(xlim = (0, 1), ylim = (-.5, -.25))
...
# Plotting D17 of model using Ash2019 tCOX
plt.hlines(-0.307, 0, 1, colors='purple', linestyles='dashed',
           label='$\Theta_{COX}$ = 0.520')
...
# Saving figure
plt.savefig('D17O2tvFtmod.jpg', dpi=800)
