...
fig1.plot(GPPx, D17_GPPx, label = '270 ppm CO2', color = 'blue')
...
xO2GPPx = np.hstack(xO2GPPx)

# Setting up figure parameters
fig2 = plt.figure(figsize = (5, 5))
with sns.axes_style("whitegrid"):
    fig2 = fig2.add_subplot(1, 1, 1)
fig2.set(xlim = (0.5, 1.5), ylim = (0, 1))

# Legend and title
fig2.set_xlabel("% Modern GPP")
fig2.set_ylabel("Mole fraction $O_2$")
fig2.set_title("Mole fraction $O_2$ vs. % Modern GPPx")

# Plotting D17 of O2t as function of [CO2]
fig2.plot(GPPx, xO2GPPx, label = '270 pppm CO2', color = 'blue')
fig2.legend(loc='best')
plt.tight_layout()
plt.savefig('xO2vGPPx.jpg', dpi=800)