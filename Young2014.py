...
K38 = 0.00014 # O2 + O1D -> O2 + O mol/yr
K39 = 0.00014 # O2 + Q1D -> O2 + Q mol/yr
K40 = 0 # O2 + Q1D -> OQ + O mol/yr
K41 = 0.00014 # O2 + X1D -> O2 + X mol/yr
...
writer = pd.ExcelWriter('Young_2014_Output.xlsx', engine = 'xlsxwriter')
